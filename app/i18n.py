...
ADMIN_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "single_use_checkbox": "Single use",
        ...
        "schedule_checkbox": "Schedule for later",
        "schedule_hint": "Off by default = active immediately. Turn on to set a start date, or a recurring weekly window (e.g. every Tuesday 18:00–19:00).",
    ...
    "es": {
        ...
        "single_use_checkbox": "Un solo uso",
        ...
        "schedule_checkbox": "Programar para más tarde",
        "schedule_hint": "Desactivado por defecto = activo al momento. Actívalo para fijar una fecha de inicio, o una franja semanal recurrente (p.ej. todos los martes de 18:00 a 19:00).",
        "starts_at_label": "Empieza el",
